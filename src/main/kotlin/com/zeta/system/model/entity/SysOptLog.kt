...
class SysOptLog : SuperEntity<Long>() {
    ...
    /** 请求地址 */
    @Schema(description = "请求地址", required = true)
    ...
    /** 类路径 */
    @Schema(description = "类路径", required = true)
    @get:NotBlank(message = "类路径不能为空")
    @TableField(value = "class_path")
    var classPath: String? = null

    /** 请求参数 */
    @Schema(description = "请求参数", required = false)
    @TableField(value = "params")
    var params: String? = null

    /** 返回值 */
    @Schema(description = "返回值", required = false)
    @TableField(value = "result")
    var result: String? = null

    /** 异常描述 */
    @Schema(description = "异常描述", required = false)
    @TableField(value = "exception")
    var exception: String? = null

    /** 消耗时间 单位毫秒 */
    @Schema(description = "消耗时间 单位毫秒", required = true)
